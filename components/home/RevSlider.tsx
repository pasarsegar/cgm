  ...
  return (
    <div className="relative w-full h-auto md:h-[600px] lg:h-[700px] overflow-hidden group bg-black">
      ...
      */}
      ...
      {slides.map((slide, index) => (
        ...
        >
          ...
          <div className={cn(
            ...
            <div className={cn(
              "space-y-2 md:space-y-6 w-full max-w-4xl transform transition-all duration-700 delay-300",
      ...
      <div className="absolute bottom-4 md:bottom-10 left-1/2 -translate-x-1/2 flex space-x-2 md:space-x-3">
        {slides.map((_, index) => (
          <button
            key={index}
            ...
            className={cn(
              ...
              index === currentSlide ? "w-6 md:w-12 bg-primary" : "w-3 md:w-6 bg-white/30"
            )}
          />
        ))}
      </div>
